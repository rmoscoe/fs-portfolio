...
def load_initial_emails(apps, schema_editor):
    ...
    Email.objects.create(event='modify portfolio item', subject='[Portfolio Notification] {model_name} {id} Modified', body='<div><p>Hello Ryan,</p><br /><br /><p>{article_and_model} has been modified in your portfolio. Details:</p><br /><table style="border-collapse:collapse"><thead><tr><th style="border-width:1px; border-color:#000000; border-style:solid;">Property</th><th style="border-width:1px; border-color:#000000; border-style:solid;">Old</th><th style="border-width:1px; border-color:#000000; border-style:solid;">New</th><th style="border-width:1px; border-color:#000000; border-style:solid;">Changed</th></tr></thead><tbody>{details}</tbody></table><br /><br /><p>If you made these changes, no further action is necessary. Otherwise, please log into your portfolio, revert the changes, and change your password.</p>')
